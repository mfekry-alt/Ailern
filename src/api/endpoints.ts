...
export const ENDPOINTS = {
  ...
  USERS: {
    ...
    STUDENT_PROFILE: (courseId: number | string, studentId: number | string) =>
      `/Users/student-profile?CourseId=${courseId}&StudentId=${studentId}`,
    ADMIN_REPORTS: '/Users/admin/all-reports',
    ADMIN_REPORT_DETAILS: (id: string | number) => `/Users/admin/report/${id}`,
    ADMIN_REPORT_REJECT: (id: string | number) => `/Users/admin/report/${id}/reject`,
  },
  ...
  COURSES: {
    ...
    APPROVE_ENROLLMENT: (id: number, studentId: number) =>
      `/Courses/${id}/enrollments/${studentId}/approve`,
    REJECT_ENROLLMENT: (id: number, studentId: number) =>
      `/Courses/${id}/enrollments/${studentId}/reject`,
    ...
    AI_RESOURCES: {
      ...
      DELETE: (courseId: number | string, resourceId: string) =>
        `/Courses/${courseId}/ai-resources/${resourceId}/delete`,
    },
  ...
  ASSIGNMENTS: {
    ...
    DELETE_FILE: (assignmentId: number, fileId: string) =>
      `/Assignments/${assignmentId}/files/${fileId}`,
    COURSE_ASSIGNMENTS_INSTRUCTOR: (courseId: number) =>
      `/Courses/${courseId}/instructors/Assignments`,
  ...
  SUBMISSIONS: {
    ...
    GET_FILES: (assignmentId: number, submissionId: number) =>
