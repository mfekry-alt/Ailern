        ...
        <div className="min-h-screen bg-[#f8fafc] dark:bg-[#020617] p-4 sm:p-8 lg:p-12 transition-colors duration-500 font-sans selection:bg-blue-500/30 pb-32">
            <div className="max-w-7xl mx-auto space-y-12">
                ...
                <div className="relative">
                    <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8 animate-fade-in">
                        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4 sm:gap-6">
                            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#21A9FF] rounded-[1.25rem] sm:rounded-[1.5rem] flex items-center justify-center shadow-xl shadow-[#21A9FF]/20 shrink-0 transform -rotate-3">
                            ...
                            <div>
                                ...
                                <p className="text-slate-500 dark:text-slate-400 mt-2 text-base sm:text-lg font-medium max-w-lg">
                        ...
                        <div className="shrink-0 group relative w-full sm:w-auto">
                            ...
                            <div className="relative flex items-center justify-center sm:justify-start gap-4 bg-white dark:bg-slate-900 px-6 py-4 sm:py-5 rounded-3xl border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/20 dark:shadow-none animate-in fade-in zoom-in duration-700">
                                <div className="p-3 bg-gradient-to-br from-[#21A9FF] to-indigo-600 rounded-2xl shadow-lg shadow-[#21A9FF]/30">
                                    <Users className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
                                </div>
                                <div>
                                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-0.5">Active Enrollment</p>
                                    <div className="flex items-baseline gap-1">
                                        <span className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tabular-nums tracking-tight">{allCourses.length}</span>
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                            ...
                            <div className="relative w-full sm:w-auto" ref={instructorRef}>
                                <button
                                    ...
                                    className="flex items-center justify-between gap-4 w-full sm:min-w-[200px] p-4 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-sm hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-300 group"
                                >
                                ...
                                {isInstructorOpen && (
                                    <div className="absolute top-[calc(100%+8px)] left-0 sm:right-0 w-full sm:w-64 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xl p-2 z-[100] animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200 max-h-[300px] overflow-y-auto">
                            ...
                            <div className="relative w-full sm:w-auto" ref={sortRef}>
                                ...
                                {isSortOpen && (
                                    <div className="absolute top-[calc(100%+8px)] left-0 sm:right-0 w-full sm:w-64 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl shadow-2xl p-2 z-[100] animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200">
                ...
                {sortedCourses.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
                    ...
                    /* Empty State */
                    <div className="flex flex-col items-center justify-center py-16 sm:py-24 px-6 text-center bg-white dark:bg-slate-900/40 backdrop-blur-md rounded-[2.5rem] sm:rounded-[3rem] border border-dashed border-slate-200 dark:border-slate-800 animate-in fade-in zoom-in duration-700">
                        <div className="relative mb-6 sm:mb-8">
                            <div className="w-24 h-24 sm:w-32 sm:h-32 bg-slate-50 dark:bg-slate-800 rounded-full flex items-center justify-center shadow-inner">
                                <BookOpen className="w-10 h-10 sm:w-14 sm:h-14 text-slate-300 dark:text-slate-600" />
                            </div>
                            <div className="absolute -bottom-2 -right-2 w-10 h-10 sm:w-12 sm:h-12 bg-white dark:bg-slate-700 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg transform rotate-12">
                                <Sparkles className="w-5 h-5 sm:w-6 sm:h-6 text-[#21A9FF]" />
                            </div>
                        </div>
                        <h3 className="text-2xl sm:text-3xl font-black text-slate-900 dark:text-white mb-3 sm:mb-4 italic">No courses found</h3>
                        <p className="text-slate-500 dark:text-slate-400 max-w-xs sm:max-w-sm mx-auto mb-8 sm:mb-10 text-base sm:text-lg leading-relaxed">
