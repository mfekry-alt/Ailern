        ...
        <div className="p-4 sm:p-6 lg:p-8 max-w-[1920px] mx-auto bg-gray-50 dark:bg-zinc-950 min-h-screen">
            <div className="max-w-2xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-[30px] font-bold text-gray-900 dark:text-zinc-100">Create User</h1>
                        <p className="text-[16px] text-gray-600 dark:text-zinc-400">Add a new user to the platform</p>
                    </div>
                    <button
                ...
                <Card variant="elevated">
                    <CardContent className="p-6 space-y-4">
                        ...
                        <div>
                            <label className="block text-[14px] font-medium text-gray-700 dark:text-zinc-300 mb-2">Password</label>
                            <input
                                type="password"
                                value={form.password}
