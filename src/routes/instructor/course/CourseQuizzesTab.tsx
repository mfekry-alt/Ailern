...
export const CourseQuizzesTab = () => {
    ...
    const getStatusBadge = (status: string) => {
        ...
        if (status === 'Scheduled') return <span className="inline-flex items-center px-2.5 py-1 rounded-lg text-[11px] font-bold uppercase tracking-wider bg-blue-50 border border-blue-200 text-blue-700 dark:bg-blue-500/10 dark:border-blue-500/20 dark:text-blue-400">Scheduled</span>;
