...
function mapApiDiscussionToUiQuestion(d: GetDiscussionDto): QnAQuestion {
    const content = d.question || '';
    ...
    if (d.answer) {
        replies.push({
            ...
            author: {
                ...
                name: d.instructorName || 'Instructor',
                avatar: d.instructorAvatar || undefined,
                role: 'instructor',
            },
            content: d.answer,
            createdAt: d.answerAt || d.createdAt,
        });
    }

    const hasInstructorReply = !!d.answer;
    ...
    const createdAt = normalizeDate(d.createdAt);
    const answerAt = d.answerAt ? normalizeDate(d.answerAt) : null;
    ...
    return {
        ...
        author: {
            id: `student-${d.studentName}`, // Use name as part of id
            name: d.studentName || 'Adam Student',
            avatar: d.studentAvatar || undefined,
            role: 'student',
        },
        createdAt: createdAt,
        updatedAt: createdAt,
        ...
        votes: d.votesCount,
        votedByMe: d.isUpVotedByCurrentUser,
        ...
        interactors: hasInstructorReply ? [
            { id: 'instructor-1', name: d.instructorName || 'Instructor', avatar: d.instructorAvatar || undefined }
        ] : [],
        hasInstructorReply,
    };
}
...
export async function fetchQuestion(questionId: string, courseId: number): Promise<QnAQuestion | null> {
