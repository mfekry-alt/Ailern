            ...
            {items.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={`group relative overflow-hidden text-left w-full p-5 rounded-2xl border transition-all duration-300 ${
                            isSelected
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-3 pl-1.5">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <div
                                    className={`flex items-center gap-1.5 text-[10px] uppercase tracking-wider font-extrabold px-2.5 py-1 rounded-xl border transition-colors duration-300 ${
                                        isReady
